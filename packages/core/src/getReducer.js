...
function combineReducers(reducers) {
  return (state, currentAction) => reducers.reduce((state, reducer) => reducer(state, currentAction), state);
}
...
export default function getReducer(reducers, state, handleActions = defaultHandleActions) {
