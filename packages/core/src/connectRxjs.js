      ...
      mergeMap(action => {
        if (action.__type === "effect") {
          return of(action).pipe(
            ...
            applyMiddleware(plugin.api.middlewares.effect, store, () =>
              handleEffect({ app, plugin, action$ })
            ),
          ...
          return of(action).pipe(
            ...
            applyMiddleware(plugin.api.middlewares.reducer, store, () =>
              handleReducer({ app, plugin })
            ),
